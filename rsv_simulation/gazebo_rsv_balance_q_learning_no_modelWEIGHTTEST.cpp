   ...
   switch (this->current_mode_)
	...
	if (controller.episode_num == MAX_EPISODE)
	{
	  ...
	  while(1){}
        ...
        if (this->disturbance_time - this->disturbance_time_prev > 8)
        {

           this->joints_[LEFT]->SetForce(0,-1000);
           this->joints_[RIGHT]->SetForce(0, 1000);

           controller.msg.disturbance++;
